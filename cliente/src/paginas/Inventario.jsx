...
const Inventario = () => {
  ...
  const librosPaginados = librosFiltrados.slice(indiceInicio, indiceInicio + ELEMENTOS_POR_PAGINA);
  const totalPaginas    = Math.ceil(librosFiltrados.length / ELEMENTOS_POR_PAGINA);
